...
class DetectAnimalBloc extends Bloc<DetectAnimalEvent, DetectAnimalState> {
  ...
  DetectAnimalBloc(
      {required this.imagePickerService, required this.tensorFlowService})
  ...
  Future<void> _onModelLoaded(
      ModelLoaded event, Emitter<DetectAnimalState> emit) async {
    await tensorFlowService.loadModel();
  }

  Future<void> _onSelectFromGalleryPressed(
      SelectFromGalleryPressed event, Emitter<DetectAnimalState> emit) async {
  ...
  Future<void> _onTakePhotoPressed(
      TakePhotoPressed event, Emitter<DetectAnimalState> emit) async {
